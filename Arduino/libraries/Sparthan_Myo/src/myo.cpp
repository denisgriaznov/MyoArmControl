...
BLERemoteCharacteristic* armband::emg_notification0(uint8_t on_off) {
  if (armband::connected) {
...
BLERemoteCharacteristic* armband::emg_notification1(uint8_t on_off) {
  if (armband::connected) {
    BLEUUID tservice = BLEUUID("d5060005-a904-deb9-4748-2c7f4a124842");
    ...
    return armband::pClient->getService(BLEUUID(tservice))->getCharacteristic(BLEUUID(tcharacteristic1));
  }
}
BLERemoteCharacteristic* armband::emg_notification2(uint8_t on_off) {
  if (armband::connected) {
    BLEUUID tservice = BLEUUID("d5060005-a904-deb9-4748-2c7f4a124842");
    ...
    return armband::pClient->getService(BLEUUID(tservice))->getCharacteristic(BLEUUID(tcharacteristic2));
  }
}
BLERemoteCharacteristic* armband::emg_notification3(uint8_t on_off) {
  if (armband::connected) {
    BLEUUID tservice = BLEUUID("d5060005-a904-deb9-4748-2c7f4a124842");
    ...
    return armband::pClient->getService(BLEUUID(tservice))->getCharacteristic(BLEUUID(tcharacteristic3));
  }
}
