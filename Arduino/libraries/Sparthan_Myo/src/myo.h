...
class armband
{
  public:
    ...
    BLERemoteCharacteristic* emg_notification0(uint8_t);
	BLERemoteCharacteristic* emg_notification1(uint8_t);
	BLERemoteCharacteristic* emg_notification2(uint8_t);
	BLERemoteCharacteristic* emg_notification3(uint8_t);
